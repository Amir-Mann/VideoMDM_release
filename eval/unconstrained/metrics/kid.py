...
def polynomial_mmd_averages(codes_g, codes_r, n_subsets=50, subset_size=1000,
                            ret_var=True, output=sys.stdout, replace=None, **kernel_args):
    """
    Note: if replace is not passed uses the old heuristic of sampling without replacement if subset_size < len(codes_g) and with replacement otherwise.
    """
