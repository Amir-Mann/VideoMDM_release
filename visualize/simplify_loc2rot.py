...
class joints2smpl:
    ...
    def __init__(self, num_frames, device_id, cuda=True, num_smplify_iters=150, supress_10_coffs_warning=False):
        ...
        smplmodel = smplx.create(config.SMPL_MODEL_DIR,
                                 ...
                                 supress_10_coffs_warning=supress_10_coffs_warning).to(self.device)
